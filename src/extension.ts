...
export function activate(context: vscode.ExtensionContext) {
    ...
    console.log('Congratulations, your extension "vscode-solution-explorer" is now active!');

    vscode.window.registerTreeDataProvider('solutionExplorer', solutionExplorerProvider);
    vscode.commands.registerCommand('solutionExplorer.refreshEntry', () => solutionExplorerProvider.refresh());
